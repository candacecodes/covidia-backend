...
card3 = Card.create(description: "Prolonged viral RNA detection does not indicate prolonged infectiousness – The duration of viral RNA shedding is variable and may increase with age and the severity of illness [39,50,54-58].", imgsrc: "imgsrc3", deck_id: 1)
card4 = Card.create(description: "Direct person-to-person respiratory transmission is the primary means of transmission of severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2) [15]. It is thought to occur through close-range contact, mainly via respiratory droplets", imgsrc: "imgsrc4", deck_id: 2)
...
card9 = Card.create(description: "Viral shedding and period of infectiousness — The precise interval during which an individual with SARS-CoV-2 infection can transmit infection to others is uncertain. The potential to transmit SARS-CoV-2 begins prior to the development of symptoms and is highest early in the course of illness; the risk of transmission decreases thereafter. Transmission after 7 to 10 days of illness is unlikely, particularly for otherwise immunocompetent patients with nonsevere infection.", imgsrc: "imgsrc9", deck_id: 3)
