...
card3 = Card.create(description: "card description 3", imgsrc: "imgsrc3", deck_id: 2)
card4 = Card.create(description: "card description 4", imgsrc: "imgsrc4", deck_id: 2)
card5 = Card.create(description: "card description 5", imgsrc: "imgsrc5", deck_id: 3)
card6 = Card.create(description: "card description 6", imgsrc: "imgsrc6", deck_id: 3)
card7 = Card.create(description: "card description 7", imgsrc: "imgsrc7", deck_id: 4)
card8 = Card.create(description: "card description 8", imgsrc: "imgsrc8", deck_id: 4)
card9 = Card.create(description: "card description 9", imgsrc: "imgsrc9", deck_id: 5)
